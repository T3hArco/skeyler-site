<div class="blog">
  ...
  <?php foreach ($local['threads'] as $thread) : ?>
    <div class="blogPost">
      <h3><a href="/forums/thread.php?threadId=<?php echo $thread['id']; ?>"><?php echo ent($thread['title']); ?></a></h3>
      ...
      <div class="postDetails">
        ...
        <a href="/forums/thread.php?threadId=<?php echo $thread['id']; ?>" class="comments"><?php echo $thread['postCount'] - 1; ?> Comments</a>
      </div>
    </div>
  <?php endforeach; ?>
</div>